...
import com.example.securestorageapp.storage.ExternalStorageManager;
...
public class ExternalStorageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        etFilename.setText("note_externe.txt");
    ...
    private void listFiles() {
        ...
        tvFileContent.setText(sb.toString().isEmpty() ? "Dossier externe vide" : sb.toString());
    }
}
